...
Release artifact: `HomeGuard-Setup-v1.1.0.exe`
...
```powershell
powershell -NoProfile -File scripts\release_gate.ps1 -InstallerPath dist\installer\HomeGuard-Setup-v1.1.0.exe -ExpectedPublisher GreyNOC
```
